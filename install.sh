...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY BAYUXD OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "bayukontol" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke BAYUXD${NC}"
    echo -e "${YELLOW}TELEGRAM : @BayuuVpn${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283824505310${NC}"
    echo -e "${YELLOW}HARGA TOKEN : [ FREE ] YANG JUAL SCRIPT NYA YATIM LU ANJING${NC}"
    echo -e "${YELLOW}©BAYUXD${NC}"
    exit 1
  fi
  clear
}
...
curl -O https://raw.githubusercontent.com/bin456789/reinstall/main/reinstall.sh && bash reinstall.sh ubuntu 20.04 && reboot
  ...
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
  echo -e "${GREEN}[+]                 REBUILD VPS SUKSES             [+]${NC}"
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  sleep 2
  clear
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer BAYUXD   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : BAYUXD      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : BAYUXD  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by BAYUXD  ${NC}"
